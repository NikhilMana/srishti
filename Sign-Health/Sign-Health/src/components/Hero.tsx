          ...
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-center">
            <div className="animate-fade-in">
              ...
              <div className="mt-8 sm:mt-10 flex flex-wrap gap-4">
                <Button 
                  className="px-6 py-6 bg-healthcare-600 hover:bg-healthcare-700 text-white rounded-lg text-lg font-medium"
                  onClick={() => navigate('/srishti')}
                >
                ...
                <Button 
                  variant="outline" 
                  className="px-6 py-6 border-healthcare-200 dark:border-healthcare-700 text-healthcare-700 dark:text-healthcare-400 hover:bg-healthcare-50 dark:hover:bg-healthcare-900/20 rounded-lg text-lg font-medium"
                >
                  Book a Demo
                </Button>
              </div>
